...
require_once('C:\\xampp\\htdocs\\PHPCalculator\\tests\\StudentManager.php');
            ...
            <div class="row">
                <div class="col-md-3 border-right">
                    <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                        ...
                        <span class="font-weight-bold"><?php echo 'IshitaBhattacharya'?></span>
                        ...
                        <form action="" method="POST">
                            <div class="row-mt-2">
                                <div class="col-md-12">
                                    ...
                                    <input type="email" class="form-control" value=<?php echo $email?> readonly=readonly>
                                </div>
                            </div>
                            <div class="row-mt-3">
                                <div class="col-md-12">
                                    <label class="labels">Contact Number</label>
                                    <input type="number" class="form-control" name="tno" value=<?php echo ' '?>>
                                </div>

                                <div class="col-md-12">
                                    <label class="labels">Address</label><br><?php echo $student->get_student_address($email)[0]?>
								</div>
								<div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" value=<?php echo $student->get_student_gender($email)[0]?> readonly=readonly>
                                </div>
								<div class="col-md-12">
                                    <label class="labels">Guardian name</label><br>
                                    <?php echo $student->get_student_guardian_name($email)[0]?>
                                </div>
								<div class="col-md-12">
                                    <label class="labels">Guardian Number</label>
                                    <input type="number" class="form-control" value=<?php echo $student->get_student_guardian_phone($email)[0]?> readonly=readonly>
                                </div>
								<div class="col-md-12">
                                    <label class="labels">Class</label>
                                    <input type="number" class="form-control" name="sclass" value=<?php echo $student->get_student_class($email)[0]?>>
                                </div>
								<div class="col-md-12">
                                    <label class="labels">Board</label>
									<input type="text" class="form-control" name="sboard" value=<?php echo $student->get_student_board($email)[0]?>>
                                </div>
...
if(isset($_POST['update']))
{
  ...
  $student_object=new StudentManager;
  $student_object->update_profile($no,$add,$class,$board,$mediums,$subjects,$email);
