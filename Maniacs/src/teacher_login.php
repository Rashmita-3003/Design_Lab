...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT id, email, pass FROM teacher WHERE email = ?";
    ...
    <div class="loginbox">
        ...
        ?>
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <a href="Teacher_forgetpassword.php">Forgot Password?</a><br>
                <a href="Registration_Teacher.php">Don't have an account?Register here!</a>
